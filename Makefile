...
obj-y += load.o string.o stm32f429-boot.o xmodem.o shell.o shell_func.o uart.o fifo.o clock.o spi.o gpio.o mpu.o qspi.o start_kernel.o sdram.o xprintf.o spiflash.o spiflash_itf.o memtester_mcu/memtester/src/memtester.o memtester_mcu/memtester/src/memtester_tests.o 
